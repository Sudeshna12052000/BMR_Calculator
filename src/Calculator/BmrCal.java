...
import javax.swing.*;
public class BmrCal extends JFrame implements ActionListener
{
    ...
    BmrCal()
    {
        ...
        ImageIcon img =new ImageIcon(ClassLoader.getSystemResource("Calculator/icons/cal.png"));
